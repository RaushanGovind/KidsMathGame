            ...
            {mode === 'learn' ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px', width: '100%', maxWidth: '1000px', justifyContent: 'center' }}>
                    ...
                    >
                        ...
                        <div style={{ fontSize: '2rem', fontWeight: '700', color: '#C2185B', background: '#FADBD8', padding: '15px 30px', borderRadius: '20px', textAlign: 'center' }}>
                            "{currentItem.context}"
                        </div>
                    </motion.div>
...
export default FeelingThinkingGame;
