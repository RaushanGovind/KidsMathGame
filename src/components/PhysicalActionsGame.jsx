...
function PhysicalActionsGame({ onBack }) {
    ...
    useEffect(() => {
        ...
        fetch(`${API_URL}/api/content/physical_actions`)
            .then(res => res.json())
            .then(data => {
            ...
            {mode === 'learn' ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px', width: '100%', maxWidth: '1000px', justifyContent: 'center' }}>
                    ...
                    >
                        ...
                        <div style={{ fontSize: '2rem', fontWeight: '700', color: '#1F618D', background: '#D4E6F1', padding: '15px 30px', borderRadius: '20px', textAlign: 'center' }}>
...
export default PhysicalActionsGame;
